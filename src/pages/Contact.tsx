          ...
          >
            ...
            <motion.div variants={fadeIn}>
              ...
              <div className="flex space-x-4">
                <a href="https://www.linkedin.com/in/karenchb/" target="_blank" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-pink-500 transition-colors" >
